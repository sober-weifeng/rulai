...
public class CookbookListPage {
    ...
    public static final String PREFIX = "https://home.meishichina.com/recipe";
    ...
    public static BizResult<CookbookListPage> crawl(String url, WebClient webClient) {
        ...
        try {
            ...
            List<HtmlElement> nextElements = page.getByXPath("//div[@class='ui-page-inner']/a");
            String nextUrl = nextElements.stream().filter(e -> "下一页".equals(e.asText())).findFirst().map(e -> e.getAttribute("href")).orElse("");
    ...
    public static void main(String[] args) {
        ...
        String url = "https://home.meishichina.com/recipe/recai/page/5/";
