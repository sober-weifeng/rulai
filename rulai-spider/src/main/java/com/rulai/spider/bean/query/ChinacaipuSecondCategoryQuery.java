...
/**
 * <p>ChinacaipuSecondCategoryQuery</p>
 * @date 2019-08-27 18:14:43
 */
public class ChinacaipuSecondCategoryQuery extends BaseQuery implements Serializable {
    ...
    public ChinacaipuSecondCategoryQuery() {
        super();
    }
    ...
    /**
     * This class corresponds to the database table chinacaipu_second_category
     */
