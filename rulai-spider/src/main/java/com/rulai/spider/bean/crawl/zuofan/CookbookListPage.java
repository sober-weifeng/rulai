...
//    public static final String PREFIX = "http://www.xiachufang.com/category";
    ...
    public static BizResult<CookbookListPage> crawl(String url, WebClient webClient) {
        ...
        try {
            String httpPrefix = "http://www.zuofan.cn";
...
//            }
            ...
            List<HtmlElement> contentElements = page.getByXPath("//div[@class='cp_list']//dd//div[@class='text']//a");
            ...
            List<HtmlElement> nextElements = page.getByXPath("//div[@class='page']/a");
    ...
    public static void main(String[] args) {
        ...
        String url = "http://www.zuofan.cn/cx/chuancai/list_13_2.html";
