...
/**
 * <p>TaipingyangTopCategoryQuery</p>
 * @date 2019-08-22 17:37:12
 */
public class TaipingyangTopCategoryQuery extends BaseQuery implements Serializable {
    ...
    public TaipingyangTopCategoryQuery() {
        super();
    }
    ...
    /**
     * This class corresponds to the database table taipingyang_top_category
     */
