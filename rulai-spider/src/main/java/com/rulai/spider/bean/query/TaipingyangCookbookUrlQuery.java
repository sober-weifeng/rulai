...
/**
 * <p>TaipingyangCookbookUrlQuery</p>
 * @date 2019-09-23 17:32:55
 */
public class TaipingyangCookbookUrlQuery extends BaseQuery implements Serializable {
    ...
    public TaipingyangCookbookUrlQuery() {
        super();
    }
    ...
    /**
     * This class corresponds to the database table taipingyang_cookbook_url
     */
