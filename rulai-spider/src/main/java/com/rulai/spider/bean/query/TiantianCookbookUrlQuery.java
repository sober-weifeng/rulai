...
/**
 * <p>TiantianCookbookUrlQuery</p>
 * @date 2019-09-19 11:29:55
 */
public class TiantianCookbookUrlQuery extends BaseQuery implements Serializable {
    ...
    public TiantianCookbookUrlQuery() {
        super();
    }
    ...
    /**
     * This class corresponds to the database table tiantian_cookbook_url
     */
