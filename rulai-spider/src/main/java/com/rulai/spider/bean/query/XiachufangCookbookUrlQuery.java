...
/**
 * <p>XiachufangCookbookUrlQuery</p>
 * @date 2019-09-17 10:06:12
 */
public class XiachufangCookbookUrlQuery extends BaseQuery implements Serializable {
    ...
    public XiachufangCookbookUrlQuery() {
        super();
    }
    ...
    /**
     * This class corresponds to the database table xiachufang_cookbook_url
     */
