...
/**
 * <p>XinshipuCookbookUrlQuery</p>
 * @date 2019-09-06 10:38:33
 */
public class XinshipuCookbookUrlQuery extends BaseQuery implements Serializable {
    ...
    private static final String PROP_KEY_LOCATION_URL = "locationUrl";
    
    private static final String PROP_KEY_IS_EFFECTIVE = "isEffective";
    
    public XinshipuCookbookUrlQuery() {
        super();
    }
    ...
    /**
     * This class corresponds to the database table xinshipu_cookbook_url
     */
    protected abstract static class GeneratedCriteria extends BaseCriteria {
        ...
        public Criteria andLocationUrlEqualToIgnoreCase(String value) {
            addCriterion("UPPER(location_url) =", value.trim().toUpperCase(), PROP_KEY_LOCATION_URL);
            return (Criteria) this;
        }
        
        public Criteria andLocationUrlEqualTo(String value) {
            addCriterion("location_url =", value, PROP_KEY_LOCATION_URL);
            return (Criteria) this;
        }
        ...
        public Criteria andLocationUrlNotEqualToIgnoreCase(String value) {
            addCriterion("UPPER(location_url) <>", value.trim().toUpperCase(), PROP_KEY_LOCATION_URL);
            return (Criteria) this;
        }
        ...
        public Criteria andLocationUrlLike(String value) {
            addCriterion("location_url like", value, PROP_KEY_LOCATION_URL);
            return (Criteria) this;
        }

        public Criteria andLocationUrlLikeIgnoreCase(String value) {
            addCriterion("UPPER(location_url) like", "%" + value.trim().toUpperCase() + "%", PROP_KEY_LOCATION_URL);
            return (Criteria) this;
        }
        

        public Criteria andLocationUrlNotLike(String value) {
            addCriterion("location_url not like", value, PROP_KEY_LOCATION_URL);
            return (Criteria) this;
        }
        
        public Criteria andLocationUrlNotLikeIgnoreCase(String value) {
            addCriterion("UPPER(location_url) not like", "%" + value.trim().toUpperCase() + "%", PROP_KEY_LOCATION_URL);
            return (Criteria) this;
        }
        

        public Criteria andLocationUrlIn(List<String> values) {
            addCriterion("location_url in", values, PROP_KEY_LOCATION_URL);
            return (Criteria) this;
        }

        public Criteria andLocationUrlNotIn(List<String> values) {
            addCriterion("location_url not in", values, PROP_KEY_LOCATION_URL);
            return (Criteria) this;
        }

        public Criteria andLocationUrlBetween(String value1, String value2) {
            addCriterion("location_url between", value1, value2, PROP_KEY_LOCATION_URL);
            return (Criteria) this;
        }

        public Criteria andLocationUrlNotBetween(String value1, String value2) {
            addCriterion("location_url not between", value1, value2, PROP_KEY_LOCATION_URL);
            return (Criteria) this;
        }
