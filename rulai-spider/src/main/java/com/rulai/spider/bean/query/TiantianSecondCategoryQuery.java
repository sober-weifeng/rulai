...
/**
 * <p>TiantianSecondCategoryQuery</p>
 * @date 2019-09-19 11:37:07
 */
public class TiantianSecondCategoryQuery extends BaseQuery implements Serializable {
    ...
    public static final String PROP_KEY_TOP_CATEGORY_ID = "topCategoryId";
    
    public static final String PROP_KEY_IS_CRAWLED = "isCrawled";
    
    public static final String PROP_KEY_IS_EFFECTIVE = "isEffective";
    
    public static final String PROP_KEY_FATHER_NAME = "fatherName";
    ...
    public TiantianSecondCategoryQuery() {
        super();
    }
    ...
    /**
     * This class corresponds to the database table tiantian_second_category
     */
    protected abstract static class GeneratedCriteria extends BaseCriteria {
        ...
        public Criteria andFatherNameEqualToIgnoreCase(String value) {
            addCriterion("UPPER(father_name) =", value.trim().toUpperCase(), PROP_KEY_FATHER_NAME);
            return (Criteria) this;
        }
        
        public Criteria andFatherNameEqualTo(String value) {
            addCriterion("father_name =", value, PROP_KEY_FATHER_NAME);
            return (Criteria) this;
        }
        ...
        public Criteria andFatherNameNotEqualToIgnoreCase(String value) {
            addCriterion("UPPER(father_name) <>", value.trim().toUpperCase(), PROP_KEY_FATHER_NAME);
            return (Criteria) this;
        }
        ...
        public Criteria andFatherNameLike(String value) {
            addCriterion("father_name like", value, PROP_KEY_FATHER_NAME);
            return (Criteria) this;
        }

        public Criteria andFatherNameLikeIgnoreCase(String value) {
            addCriterion("UPPER(father_name) like", "%" + value.trim().toUpperCase() + "%", PROP_KEY_FATHER_NAME);
            return (Criteria) this;
        }
        

        public Criteria andFatherNameNotLike(String value) {
            addCriterion("father_name not like", value, PROP_KEY_FATHER_NAME);
            return (Criteria) this;
        }
        
        public Criteria andFatherNameNotLikeIgnoreCase(String value) {
            addCriterion("UPPER(father_name) not like", "%" + value.trim().toUpperCase() + "%", PROP_KEY_FATHER_NAME);
            return (Criteria) this;
        }
        

        public Criteria andFatherNameIn(List<String> values) {
            addCriterion("father_name in", values, PROP_KEY_FATHER_NAME);
            return (Criteria) this;
        }

        public Criteria andFatherNameNotIn(List<String> values) {
            addCriterion("father_name not in", values, PROP_KEY_FATHER_NAME);
            return (Criteria) this;
        }

        public Criteria andFatherNameBetween(String value1, String value2) {
            addCriterion("father_name between", value1, value2, PROP_KEY_FATHER_NAME);
            return (Criteria) this;
        }

        public Criteria andFatherNameNotBetween(String value1, String value2) {
            addCriterion("father_name not between", value1, value2, PROP_KEY_FATHER_NAME);
            return (Criteria) this;
        }
